...
<form class="form-horizontal" role="form" onsubmit="event.preventDefault(); reporte_diario_eliminar()">
 
<h4><span class="label label-default">Eliminar Parte Diario</span></h4>
 ...
 <div class="col-lg-6">
   <fieldset>
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-lg-10">
          <select class="form-control" id="finca" onchange="llama_personal()">   
              <?php
