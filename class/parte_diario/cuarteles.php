...
<div class="panel-body" id="Panel1" style="height:<?php echo $panel; ?>px">
...
CAST(tb_cuartel.nombre AS SIGNED) as orden_cuartel,
        ...
        <tr>
          <th><input type="checkbox" value="'.$id.'" name="'.$contador.'" style="width: 20px; height:15px" class="cbxcuartel" id="cuartel'.$contador.'" ></th>
          <td><input type="text" class="form-control" id="nombre'.$contador.'" style="width: 80px; height:25px" value="'.$nombrecuartel.'" disabled></td>
          <td><input type="text" class="form-control" id="hileras_ant_'.$contador.'" style="width: 60px; height:25px" value="'.$hileras.'" disabled></td>
          <td><input type="number" class="form-control-hil" id="hileras_'.$contador.'" name="'.$contador.'" style="width: 70px; height:25px" value="'.$hileras.'" disabled></td>
          <td><input type="text" class="form-control" id="has_'.$contador.'" style="width: 62px; height:25px" value="'.$has.'" disabled></td>
          <td><input type="text" class="form-control-has" autocomplete="off" id="has_seleccionadas'.$contador.'" style="width: 70px; height:25px" value="0" disabled></td>
          </td>
        </tr>
        ';
