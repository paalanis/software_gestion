...
<form class="form-horizontal" method="post" action="class/parte_diario/reporte_excel_labores.php">
 
<h4><span class="label label-default">Reporte Labores por Cuartel</span></h4>
 ...
 <div class="col-lg-6">
   ...
   <fieldset>
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-lg-10">
          <select class="form-control" id="labor" name='id_labor'>   
              <option value=""></option>
              <?php
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-lg-5">
          ...
          <button type="button" class="btn btn-primary" onclick="reporte_labores()">Buscar</button>   
          </div>
