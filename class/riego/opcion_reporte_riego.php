...
<form class="form-horizontal" method="post" action="class/riego/reporte_excel.php">

<h4><span class="label label-default">Reporte Riego</span></h4>
 ...
 <div class="col-lg-6">
   ...
   <fieldset>
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-lg-10">
          <select class="form-control" id="caudalimetro" name="post_cauda" onchange="llama_reporte_valvula()">   
              <option value=""></option>
              <?php
      ...
      <div class="form-group form-group-sm">
        <label  class="col-lg-2 control-label">Valvulas</label>
        <div class="col-lg-10" id="div_reporte_valvulas">
