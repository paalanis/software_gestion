   ...
   <fieldset>
    ...
    <div class="form-group form-group-sm">
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-lg-4">
          <input type="text" class="form-control" autocomplete="off" id="diario_remito" placeholder="Rto N° 0000-00000000" value="" aria-describedby="basic-addon1" required  autofocus="">
        </div>
        <div class="col-lg-3">
          <input type="text" class="form-control" autocomplete="off" id="diario_ciu" placeholder="CIU" style="background-color: #c9302c; color: white" value="" aria-describedby="basic-addon1">
        </div>
      </div>
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-lg-4">
          <div align="left">
          <input class="form-control_cosecha" type="checkbox"  value="mecanica" id="mecanica">
          </div>
        </div>
        <label for="inputPassword" class="col-lg-2 control-label">Manual</label>
        <div class="col-lg-4">
          <div align="left">
          <input class="form-control_cosecha" type="checkbox"  value="manual" id="manual">
          </div>
        </div>
        </div>       
        </div>
...
$(function() {
  ...
  $(function() {
    $('#diario_variedad').change(function() {
     ...
     $("#div_cuarteles").html('<div class="text-center"><div class="loadingsm"></div></div>');
     $("#div_cuarteles").load("class/parte_diario/cuarteles.php", {finca: finca, variedad: variedad}); 
