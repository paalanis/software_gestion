...
<h4><span class="label label-default">Remitos de cosecha terminados</span></h4>
...
tb_cosecha
WHERE
tb_cosecha.pendiente = '1' and tb_cosecha.id_finca = '$id_finca_usuario'
GROUP BY
        ...
        $.ajax({
            ...
            success: function(data){
              ...
              if (data.success == 'true') {
                ...
                setTimeout("llama_terminados_cosecha()", 1050);
              } else {
