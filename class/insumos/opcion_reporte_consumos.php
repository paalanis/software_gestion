...
<form class="form-horizontal" method="post" action="class/insumos/reporte_excel.php">
 
<h4><span class="label label-default">Reporte de Consumos</span></h4>
   ...
   <fieldset>
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-lg-5">
          ...
          <button type="button" class="btn btn-primary" onclick="reporte_consumos()">Buscar</button>  
          </div>
