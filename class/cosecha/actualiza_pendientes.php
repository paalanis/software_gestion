...
Round(SUM(tb_cosecha.kilos)) as kilos,
...
<form class="form-horizontal" role="form" onsubmit="event.preventDefault(); actualiza_remitos()">
       ...
       <div class="form-group form-group-sm">
        ...
        <div class="col-lg-4">
          <input type="text" class="form-control" autocomplete="off" id="pendiente_kilos" value="<?php echo $kilos;?>" placeholder="Completar" style="background-color: #c9302c; color: white" value="" autofocus="" required>
          </div>
