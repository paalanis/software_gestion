...
if (mysqli_connect_errno()) {
	...
	if ($ciu == '' || $kilos == '') {
		...
		for ($i=$idinicial; $i <=$idfinal ; $i++) { 
			...
			VALUES ('$fecha', '$remito', '$ciu', '$transporte', '$chofer', '$patente', '$finca', '$destino', '$mecanica', '$propia', '$eventual', '$fichas', '$precio', '$cuartel', '$has', '$totalhas', round('$horas_proporcional',2), round('$kg_proporcional',2), '$obs', '$pendiente', '$id_global')";
